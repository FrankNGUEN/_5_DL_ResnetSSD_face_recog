...
prototxt_file = file_path + 'models/Resnet_SSD_deploy.prototxt'
caffemodel_file = file_path + 'models/Res10_300x300_SSD_iter_140000.caffemodel'
...
image = cv.imread('images/Steve_Jobs.jpg')
